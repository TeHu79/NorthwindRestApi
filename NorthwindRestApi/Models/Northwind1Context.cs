...
public partial class Northwind1Context : DbContext
{
    public Northwind1Context()
    {
    }

    public Northwind1Context(DbContextOptions<Northwind1Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TilaussummatDesimaali>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TilaussummatDesimaali");
